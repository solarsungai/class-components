...
import { getPopulationForYear, getCo2ForYear, createYearDataMap } from '../../utils/data-transformers';
  ...
  return (
    <div className={styles.countryList}>
      {filteredCountries.map((country) => {
          ...
          const population = countryYearMap ? getPopulationForYear(countryYearMap, selectedYear) : undefined;
